        ...
        <div class="flex space-x-4 p-4 bg-gray-100 my-2 mx-5 rounded-xl">
            <div class="flex flex-col w-2/3">
                <div class="flex space-x-5 h-44">
                    <div class="w-1/2 bg-purple-800 rounded-xl p-4 relative overflow-hidden">
                        ...
                        <div class="flex flex-col">
                            <div class="flex justify-between mb-4">
                                ...
                                <button class="bg-purple-800 p-2 rounded-lg w-10 h-10 items-center justify-center text-purple-400 z-10">
                    ...
                    <div class="w-1/2 bg-blue-500 rounded-xl p-4 relative overflow-hidden">
                        ...
                        <div class="flex flex-col">
                            <div class="flex justify-between mb-4">
                                ...
                                <button class="bg-blue-600 p-2 rounded-lg w-10 h-10 items-center justify-center text-blue-300 z-10">
                                    <i class="fas fa-ellipsis-h m-1"></i>
                                </button>
                            </div>
                            <div class="flex space-x-1 text-white text-3xl font-bold mb-3">
                    ...
                    <table class="flex flex-col w-full space-y-5 border border-gray-200 p-5 my-4 rounded-lg">
                        ...
                        <tbody class="space-y-4">
                                ...
                                <tr class="flex">
                                    <td class="flex w-10/12 items-start">
                                        <div class="flex space-x-3">
                                            <img class="rounded-full w-10 h-10" src="{{Storage::url($value->profile_photo_path)}}" alt="profile_picture">
                            ...
                            <tr class="flex">
                                ...
                                <td class="flex w-2/12 justify-around font-bold">$ {{$data['total_payment']-$data['total_paypal_commissions']}}</td>
                                <td class="flex w-2/12 justify-around font-bold">$ {{$data['total_paypal_commissions']}}</td>
            ...
            <div class="flex flex-col w-1/3 space-y-4">
                {{-- <div class="flex flex-col justify-between h-44"> --}}
                    <a href="{{route('admin.users')}}" class="flex w-full border-2 border-green-500 bg-white text-gray-700 hover:bg-green-500 hover:text-white rounded-xl p-4 space-x-3 items-center transition-all duration-300 ease-in-out relative overflow-hidden">
                    ...
                    <a href="{{route('admin.users')}}" class="flex w-full border-2 border-blue-500 bg-white text-gray-700 hover:bg-blue-500 hover:text-white rounded-xl p-4 space-x-3 items-center transition-all duration-300 ease-in-out relative overflow-hidden">
                    ...
                    <a href="{{route('admin.users')}}" class="flex w-full border-2 border-red-500 bg-white text-gray-700 hover:bg-red-500 hover:text-white rounded-xl p-4 space-x-3 items-center transition-all duration-300 ease-in-out relative overflow-hidden">
                    ...
                    <a href="{{route('admin.users')}}" class="flex w-full border-2 border-purple-700 bg-white text-gray-700 hover:bg-purple-700 hover:text-white rounded-xl p-4 space-x-3 items-center transition-all duration-300 ease-in-out relative overflow-hidden">
                    ...
                    <a href="{{route('exam.index')}}" class="flex w-full border-2 border-yellow-700 bg-white text-gray-700 hover:bg-yellow-700 hover:text-white rounded-xl p-4 space-x-3 items-center transition-all duration-300 ease-in-out relative overflow-hidden">
