          ...
          <table class="text-left w-full border-collapse"> <!--Border collapse doesn't work on this site yet but it's available in newer tailwind versions -->
            <thead>
              <tr>
                ...
                <th class="py-4 px-6 bg-gray-100 font-bold uppercase text-sm text-gray-600 border-b border-gray-400">Username</th>
            ...
            <tbody>
              @foreach ($invoices as $invoice)
                  <tr class="hover:bg-gray-200">
                      ...
                      <td class="py-4 px-6 border-b border-gray-400"><a href="{{route('profile.show',$invoice->user->id)}}" class="hover:text-blue-600 hover:underline">{{$invoice->user->username}}</a></td>
