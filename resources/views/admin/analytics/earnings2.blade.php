            ...
            <table class="w-full">
                <thead>
                    <tr class="border whitespace-nowrap">
                        ...
                        <th class="py-4 text-right px-6">Income (per class)</th>
                        <th class="py-4 text-right px-6">Income (per student)</th>
                        <th class="py-4 text-right px-6">Payment (per student)</th>
                    ...
                    @foreach ($groupedClasses as $classes)
                        ...
                        <tr class="border">
                            ...
                            <td class="px-6 py-4 text-sm text-right">$
                                {{ $totalIncomePerStudent - $totalPaymentPerStudent }}</td>
                        </tr>
                    @endforeach
                </tbody>
                <tfoot class="text-md">
                    <tr class="border">
                        ...
                        <td class="px-6 py-4 font-bold text-right">$ {{ $totalIncome - $totalPayment }}</td>
                    </tr>
                </tfoot>
            </table>
        </div>
