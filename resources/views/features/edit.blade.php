                    ...
                    <div class="divide-y">
                        ...
                        <div>
                            <div class="py-6 space-y-1">
                                ...
                                <input type="text" name="name" id="name" placeholder="Enter feature name"
                                    ...
                                    class="w-full rounded-md p-3 @if ($errors->has('name')) border-red-600 @else border-gray-300 @endif ">
                                @if ($errors->has('name'))
                        ...
                        <div class="pb-6 space-y-1">
                            ...
                            <input type="text" name="details" id="details" placeholder="Enter feature details"
                                value="@if ($feature->details != null) {{ json_decode($feature->details)->content }} @endif"
                        ...
                        <div class="pb-6 space-y-1">
                            ...
                            <input type="text" name="link" id="link" placeholder="Enter feature detail link"
                                value="@if ($feature->details != null && json_decode($feature->details)->link != 'null') {{ json_decode($feature->details)->link }} @endif"
