        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                ...
                @foreach ($courses as $course)
                    {{-- <x-course_card id="{{$course->course_id}}" name="{{$course->course_name}}" image="https://img.pixers.pics/pho_wat(s3:700/FO/60/89/19/91/700_FO60891991_9eb8248aebe7688d0b16c848c91d86e9.jpg,700,467,cms:2018/10/5bd1b6b8d04b8_220x50-watermark.png,over,480,417,jpg)/almohadas-largas-ee-uu-y-el-reino-unido-de-la-bandera.jpg.jpg"/> --}}
                    <div onclick="location.href='courses/{{$course->course_id}}';" class="group flex flex-row bg-gray-100 rounded-lg w-full justify-between mb-10 shadow-md hover:shadow-xl cursor-pointer h-40 items-center">
                        ...
                        <div class="w-full flex flex-col justify-start">
                            ...
                            <h1
                                class="text-2xl leading-6 text-blue-800 font-semibold"
                            >
