...
{{-- <div x-data="{ showModal1: false, showModal2: false, showModal3: false }" :class="{'overflow-y-hidden': showModal1 || showModal2 || showModal3}"> --}}
    ...
    >
        ...
        >
            ...
            <button
                wire:click="edit()"
                onclick="saveSchedule({{isset($user_schedule) ? count($user_schedule) : 0}},'schedule.update',{{Auth::user()->roles->pluck('id')[0]}});toggleCellBlock()"
    ...
    >
        ...
        <div
            ...
            @click.outside="showModal2 = false"
            x-show="showModal2"
            x-transition:enter="transition transform duration-300"
            x-transition:enter-start="scale-0"
            x-transition:enter-end="scale-100"
    ...
    >
        ...
        <div
            class="relative bg-white shadow-lg rounded-lg text-gray-900 z-20"
            @click.outside="showModal3 = false"
            x-show="showModal3"
            x-transition:enter="transition transform duration-300"
            x-transition:enter-start="scale-0"
            x-transition:enter-end="scale-100"
