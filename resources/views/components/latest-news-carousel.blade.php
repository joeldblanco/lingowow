<div class="mt-10 mb-20">
   <h3 class="text-4xl font-bold my-10 text-gray-800">Latest News</h3>
   <div class="gallery js-flickity" data-flickity-options='{ "wrapAround": true }'>
      {{-- NEWS-CARD --}}
      <div class="gallery-cell">
         <div class="relative bg-white py-6 px-6 rounded-3xl w-64 shadow-xl mx-10 mt-7 mb-2">
            ...
            <div class="mt-8">
               <p class="text-xl font-semibold my-2">Practice Rooms</p>
      ...
      <div class="relative bg-white py-6 px-6 rounded-3xl w-64 shadow-xl mx-10 mt-7 mb-2">
         ...
         <div class="mt-8">
            <p class="text-xl font-semibold my-2">Conversational Practices</p>
            <div class="flex space-x-2 text-gray-400 text-sm">
                  <!-- svg  -->
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
