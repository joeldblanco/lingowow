                    ...
                    @foreach ($plan->features as $feature)
                        <div
                            ...
                            <div class="flex justify-end text-right w-full items-center space-x-2"
                                ...
                                <p class="text-md @if (!$feature->pivot->status) text-gray-400 line-through @endif">
                                ...
                                @if ($feature->details != null)
                                    <div class="relative cursor-pointer">
                                        <div x-show="modalDetails" @mouseenter="modalDetails = true"
                                            ...
                                            <p class="text-left">{{ json_decode($feature->details)->content }}</p>
                                            @if (json_decode($feature->details)->link != 'null')
                                                <a href="{{ json_decode($feature->details)->link }}" target="_blank"
