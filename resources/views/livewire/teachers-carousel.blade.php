                    ...
                    <div class="gallery js-flickity" data-flickity-options='{ "wrapAround": true }'>
                        ...
                        <div class="gallery-cell">
                            <div class="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl mt-7 mb-2 mx-10">
                                <img src="{{Storage::url($teacher->profile_photo_path)}}" class="flex items-center border-2 rounded-full shadow-xl w-32" />
                                <div class="mt-8">
                                    <p class="text-xl font-semibold my-2">{{$teacher->first_name}} {{$teacher->last_name}}</p>
                                    ...
                                    <div class="flex justify-center">
                                        <button wire:click.prevent="loadSchedule({{$teacher->id}})" class="inline-block bg-blue-800 text-white px-6 py-2 rounded hover:bg-blue-900 hover:text-white mt-5">Select</button>
                                    </div>
                                </div>
                            </div>
                        </div>
