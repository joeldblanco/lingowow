                        ...
                        @foreach (Cart::content() as $item)
                            ...
                            <tr>
                                ...
                                <a href="#">
                                    ...
                                    <button wire:click.prevent="removeItem('{{$item->rowId}}')" class="text-gray-700 md:ml-4">
                                ...
                                <div class="w-20 h-10">
                                    <div class="relative flex flex-row w-full h-8">
                                        <button wire:click.prevent="decrementQtyItem('{{$item->rowId}}')"><i class="fas fa-minus"></i></button>
                                        <input type="text" value="{{$item->qty}}" class="w-full font-semibold text-center text-gray-700 bg-gray-200 outline-none focus:outline-none hover:text-black focus:text-black" disabled />
                                        <button wire:click.prevent="incrementQtyItem('{{$item->rowId}}')"><i class="fas fa-plus"></i></button>
                                    </div>
                                </div>
                                </td>
                        ...
                        <div class="p-4">
                            ...
                            <div class="justify-center md:flex">
                                <div class="flex items-center w-full h-13 pl-3 bg-gray-100 border rounded-full">
                                    ...
                                    <button class="text-sm flex items-center px-3 py-1 text-white bg-gray-800 rounded-full outline-none md:px-4 hover:bg-gray-700 focus:outline-none active:outline-none" wire:click="applyCoupon">
