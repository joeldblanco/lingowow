<div>
    ...
    {{-- @if ($role != 'admin') --}}
    <div class="container mx-auto mt-10" x-data="{ editBtn: true, edit: false, showModal1: false, showModal2: false, showModal3: false, showModalAbsence: false, event: {{ $event }} }" x-cloak>
