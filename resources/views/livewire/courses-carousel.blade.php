                    ...
                    <div class="container shadow-lg group container rounded-md bg-white max-w-sm flex justify-center items-center mx-auto content-div"
                        ...
                        <div>
                            ...
                            <div class="py-8 px-4 bg-white  rounded-b-md fd-cl group-hover:opacity-25">
                                <span
                                    class="block text-lg text-gray-800 font-bold tracking-wide">{{ $course->name }}</span>
                                <span class="block text-gray-600 text-sm">{{ $course->description }}
                                </span>
                            </div>
                        </div>
