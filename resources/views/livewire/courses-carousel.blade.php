            ...
            <div class="gallery-cell">
                ...
                <div class="relative bg-white rounded-3xl w-96 my-4 shadow-xl mt-7 mb-2 mx-5 flex flex-col">
                    <div
                        ...
                        style="background-image: url('{{Storage::url($course->course_image_url)}}');"
                        onMouseOver="this.style.backgroundImage='linear-gradient(to right, rgba(126, 213, 111, 0.801), hsla(160, 64%, 43%, 0.801)), url({{Storage::url($course->course_image_url)}})'"
                        onMouseOut="this.style.backgroundImage='url({{Storage::url($course->course_image_url)}})'"
                        >
                        <div>
                            ...
                            <div class="py-8 px-4 bg-white  rounded-b-md fd-cl group-hover:opacity-25">
                                <span
                                    class="block text-lg text-gray-800 font-bold tracking-wide">{{ $course->course_name }}</span>
                                <span class="block text-gray-600 text-sm">{{ $course->course_description }}
                                </span>
                            </div>
                        </div>
                        <div class="absolute opacity-0 fd-sh group-hover:opacity-100 text-center px-4">
                            <span
                                class="text-3xl font-bold text-white tracking-wider leading-relaxed font-sans">{{ $course->course_name }}</span>
