<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    {{-- <x-post-card author="Joel Blanco" size="md" author_pic_url="https://picsum.photos/200" post_pic_url="https://picsum.photos/200">
        ...
        <div class="text-gray-500">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatum tenetur earum laborum delectus deleniti voluptatem, consectetur voluptate ullam recusandae iste rem qui necessitatibus. Commodi pariatur enim illum ducimus corporis possimus?
        </div>
