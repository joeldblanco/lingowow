...
class UpcomingTestForStudent extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('We are writing to remind you that your test is in ' . $this->timeUntilTest . ', with teacher ' . $this->teacher->first_name . ' ' . $this->teacher->last_name . '.')
