...
Route::middleware(['auth:sanctum', 'verified', 'role:student|teacher|admin'])->get('/courses/{num}/{num2}', [CoursesController::class, "show_units"])->name('courses');
Route::middleware(['auth:sanctum', 'verified', 'role:student|teacher|admin'])->get('/courses/{num}', [CoursesController::class, "show_modules"])->name('courses');
Route::middleware(['auth:sanctum', 'verified', 'role:student|teacher|admin'])->get('/courses', [CoursesController::class, "index"])->name('courses');
